...
public class MyScene implements Scene {
    ...
    public void render() {
        ...
        if (won) {
            ...
            //BOTONES
            this.engine.drawImage((int)((double)this.engine.getWidth()*0.7916666), (int)((double)this.engine.getHeight()*0.041666), (int)((double)this.engine.getWidth()*0.04), (int)((double)this.engine.getHeight()*0.025), "Lupa");
            ...
            this.engine.drawImage((int)((double)this.engine.getWidth()*0.0138888), (int)((double)this.engine.getHeight()*0.046296), (int)((double)this.engine.getWidth()*0.04), (int)((double)this.engine.getHeight()*0.025), "Flecha");
